    ...
    public void LogPlayerData(int n)
    {
        ...
        using (StreamWriter writer = File.AppendText(path))
        {
            ...
            if (new FileInfo(path).Length == 0)
            {
                ...
                writer.WriteLine("Timestamp,EventType,BlueBallsLeft,PurpleBallsLeft,BlueLives,PurpleLives");
            ...
            writer.WriteLine($"{timestamp},{eventType},{_latestBlueBalls},{_latestPurpleBalls},{_latestBlueLives},{_latestPurpleLives}");
        }
    }
